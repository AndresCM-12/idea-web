...
export default function Sublimacion() {
    ...
    <main className="h-fit bg-white mt-28 pb-28">
        <div className="flex md:flex-row xs:flex-col gap-x-6 bg-ideaRed text-white h-fit items-center relative bg-opacity-80">
         <Image className="xxl:w-1/3 xl:w-1/3 lg:w-2/5 md:w-1/2 xs:w-full h-full object-cover" alt="imagen de letras 3D" src={"/products/sublimacion/hero.png"} width={10} height={10} />
         <div className="flex flex-col items-start md:py-0 xs:py-10 md:px-0 xs:px-3 lg:pl-20 xs:pl-3"> 
          <h1 className="font-bold text-4xl mb-4">SUBLIMACIÓN</h1>
          <p className="font-semibold text-sm">Dejaremos a tus clientes ¡Impresionados! Gracias a<br/>
           la maravillosa técnica de sublimación en artículos<br/>promocionales.
          </p>
           <p className="mt-2 text-sm">
           Plasmamos tu IDEA en prendas textiles como<br/>Playeras, Sudaderas, Uniformes, Gorras y más.
          </p>
          <p className="mt-2 text-sm">
          Promociónate en tazas, termos y demás artículos<br/>promocionales, con una gran variedad de colores y<br/>detalles de calidad.
          </p>
          <p className="mt-2 text-sm">
          Reconoce ese gran logro, inmortaliza un gran recuerdo.
          </p>
          <Link href={"/contacto"}>
