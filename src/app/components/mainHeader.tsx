...
const MainHeader = () => {
    return (
        <header className="z-50 fixed top-0 w-full shadow">
         <div className='flex items-center justify-between md:px-16 sm:px-8 xs:px-4 py-8 bg-white text-black relative'>
